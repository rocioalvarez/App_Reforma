...
import com.soma.estadias2017.app_002.TraspasoTerceros;

public class FingerprintTerceros extends FingerprintManager.AuthenticationCallback {
    ...
    // Constructor
    public FingerprintTerceros(Context mContext) {
        context = mContext;
    }
    ...
    public void update(String e, Boolean success){
        ...
        if(success){
            ...
            context.startActivity(new Intent(context, ComprobanteTraspasoTerceros.class));
        }
    }
}
