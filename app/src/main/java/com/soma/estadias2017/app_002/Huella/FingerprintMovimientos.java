...
import com.soma.estadias2017.app_002.ComprobanteTraspasoTerceros;
import com.soma.estadias2017.app_002.ListaSaldoDetallado;
import com.soma.estadias2017.app_002.R;
import com.soma.estadias2017.app_002.SaldoDetallado;

@RequiresApi(api = Build.VERSION_CODES.M)
public class FingerprintMovimientos extends FingerprintManager.AuthenticationCallback {
    ...
    // Constructor
    public FingerprintMovimientos (Context mContext) {
        context = mContext;
    }
    ...
    public void update(String e, Boolean success){
        ...
        if(success){
            ...
            context.startActivity(new Intent(context, ListaSaldoDetallado.class));
