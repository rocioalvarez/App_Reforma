...
/*
public class PDFInversion extends Activity implements OnClickListener {

    private final static String NOMBRE_DIRECTORIO = "com.soma.estadias2017.app_002";
    private final static String NOMBRE_DOCUMENTO = "comprobante.pdf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btnGenerarpdf).setOnClickListener(this);
    }
    ...
    public void onClick(View v) {
        ...
        try {
            ...
            font = FontFactory.getFont(FontFactory.HELVETICA, Font.BOLD);
